...
public class CorpDaoImpl implements CorpDao{
	...
	// 지원자 현황 페이징
	@Override
	public int selectApplyCnt(SqlSessionTemplate sst, String corpNo) {
		return sst.selectOne("corpMapper.selectApplyCnt", corpNo);
	}
	...
	public void updatePost(SqlSessionTemplate sst, CorpVo vo) {
		sst.update("jobPostMapper.updatePost", vo);
	}
