        ...
        <div class="main-wrap">
			<div class="list-wrap">
				...
				<c:forEach items="${adminList}" var="f">
	                ...
	                <div class="td" id="title"><a href="/el/qna/detail?no=${ f.no }" target="_blank" id="title-a">${ f.title }</a></div>
	                <div class="td" id="enrollDate">${ f.enrollDate }</div>
	                <div class="td"><button onclick="location.href = '/el/qna/answerAdminWrite?no=${ f.no }'" id="edit">답변</button></div>
